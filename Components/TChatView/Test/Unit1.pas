...
type
  TForm1 = class(TForm)
    ...
    procedure OnLinkMouseMoveProcessing(SenderCV: TComponent; DrawCont: TDrawContainerInfo; LinkInfo:TLinkInfo);//¦ёиЁё¦кв°· ·v°·Ё ¤Ё ¬¬vv·ї
    procedure OnLinkMouseUpProcessing(Button: TMouseButton; X, Y: Integer; SenderCV: TComponent; DrawCont: TDrawContainerInfo; LinkInfo:TLinkInfo);//¦ёиЁё¦кв°· ·v°·Ё ¤Ё ¬¬vv·ї
...
procedure TForm1.OnLinkMouseUpProcessing(Button: TMouseButton; X, Y: Integer; SenderCV: TComponent; DrawCont: TDrawContainerInfo; LinkInfo:TLinkInfo);//¦ёиЁё¦кв°· ·v°·Ё ¤Ё ¬¬vv·ї
BEGIN
...
var i, link: integer;
begin
//проблема в том что если мы для каждого ника будем добавлять свой стиль
//то при уходе ника их чата мы должны удалять этот стиль!
//а это значит номера стилей у ников следующих за удаленным сдвинуться!
