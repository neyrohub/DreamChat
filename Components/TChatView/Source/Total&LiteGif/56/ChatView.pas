...
const
  cvVersion     = 'TChatView v0.56 by Bajenov Andrey. Copy right 2007(c)';
  cvsBreak      = -1;
  cvsCheckPoint = -2;
  cvsPicture    = -3;
  cvsHotSpot    = -4;
...
{поразмыслить над объединением их в один класс}
  ...
  {------------------------------------------------------------------}
  TLinkMouseMove = procedure (Sender:TChatView; DrawContainer: TDrawContainerInfo; LinkInfo:TLinkInfo) of object;//обработчик клика на ссылке
  TLinkMouseUp = procedure (Button: TMouseButton; X, Y: Integer; Sender:TChatView; DrawContainer: TDrawContainerInfo; LinkInfo:TLinkInfo) of object;//обработчик клика на ссылке
