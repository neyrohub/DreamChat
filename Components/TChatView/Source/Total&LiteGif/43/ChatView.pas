...
uses
  ...
  litegif1, CVLiteGifAniX, ExtCtrls;
  {------------------------------------------------------------------}



const
  cvVersion     = 'TChatView v0.43 by Bajenov Andrey';
  cvsBreak      = -1;
  cvsCheckPoint = -2;
  cvsPicture    = -3;
  cvsHotSpot    = -4;
...
//    procedure AdjustChildrenCoords;
  ...
  public
    ...
    property CursorContainer: integer read FCursor write FCursor;
...
{===============================================================================}
   if (no = -8)  then // gifanimate
     ...
     TGifAni(li.gr).DrawFrame(li.imgNo, xshift - HScrollPos, dli.Bottom^ - dli.Height - yshift);
     end;
{===============================================================================}
   if (no = -7)  then // gif }
     begin
