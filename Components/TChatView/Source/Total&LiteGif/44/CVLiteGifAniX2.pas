...
BEGIN
FDestCanvas.Draw(MirrorImagesX[MirrorNumber] {- xshift}, yshift, FGifImage.Bitmap[FrameIndex]);
//FDestCanvas.Draw(MirrorImagesX[MirrorNumber],
//                 MirrorImagesY[MirrorNumber],
//                 FGifImage.Bitmap[FrameIndex]);
end;
