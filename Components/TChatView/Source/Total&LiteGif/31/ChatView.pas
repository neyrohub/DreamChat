...
const
  cvVersion     = 'TChatView v0.31 by Bajenov Andrey';
  cvsBreak      = -1;
  cvsCheckPoint = -2;
  cvsPicture    = -3;
  cvsHotSpot    = -4;
...
//    procedure CMInvalidate(var Message: TMessage); message CM_INVALIDATE;
    function FindItemAtPos(X,Y: Integer): Integer;//ищет по всему массиву объектов
    function FindItemAtScreenPos(X,Y: Integer): Integer;//ищет по отображаемому массиву
...
{===============================================================================}
   if (no = -5)  then // WinControl
     ...
     //высоту контрола
     TWinControl(li.gr).Top := dli.Bottom^ - dli.Height - VPos * SmallStep;
