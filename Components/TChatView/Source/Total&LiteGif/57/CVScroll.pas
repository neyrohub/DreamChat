...
type
  ...
  private
    ...
    function GetIntVertScrollPosition: Integer;
  protected
    XSize, YSize: Integer;
...
begin
  with Message do
    case ScrollCode of
      ...
      SB_THUMBPOSITION:
        begin
        SetVPos(GetIntVertScrollPosition);
        end;
      SB_THUMBTRACK: if FTracking then
        begin
        SetVPos(GetIntVertScrollPosition);
        //FDebugText := 'SB_THUMBTRACK ' + IntToStr(GetIntVertScrollPosition);
      ...
      SB_ENDSCROLL:
        begin
        //SetVPos(GetRealVertScrollPosition);
        //FDebugText := 'SB_ENDSCROLL ' + IntToStr(Pos) +
        //              ' GetIntVertScrollPosition ' + IntToStr(GetIntVertScrollPosition);
...
begin
  ...
  SetScrollPos(Handle, SB_VERT, VPos, TRUE);
...
{------------------------------------------------------}
function TCVScroller.GetIntVertScrollPosition: Integer;
var
  ScrollInfo: TScrollInfo;
  Code: Integer;
begin
...
{-------------------------------------------------------}
function TCVScroller.GetHScrollPos: Integer;
begin
  GetHScrollPos := HPos;
end;
{-------------------------------------------------------}
