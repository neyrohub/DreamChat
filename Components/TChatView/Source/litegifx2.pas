...
// generally usefull routines
    ...
    public
        FramesOverBitmaps:     boolean;            // Bitmaps was overrride by Frames
        constructor Create;
        ...
        procedure SetBitmap(image: integer; Btmp:TBitmap);
        ...
        property Bitmap[Image: integer]:            TBitmap                 read GetBitmap write SetBitmap;
...
procedure TGif.SetBitmap(image: integer; Btmp:TBitmap);
begin
if FramesOverBitmaps = false then Bitmap[image].Assign(Btmp);
end;
{ ---------------------------------------------------------------------------- }
