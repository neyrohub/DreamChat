...
Var MyNote: String;
begin
MyNote := 'Получена строка из PluginManagera: ' + PluginTypeNote;
...
begin
PluginInfo.PluginComment := 'Версия T07';
PluginInfo.PluginAutorName := 'Автор плагина: Андрей';
PluginInfo.PluginName := 'Original Plugin TCPkrnl';
PluginInfo.InternalPluginFileName := 'TCPkrnl.dll';
PluginInfo.PluginType := Communication;
result := @PluginInfo;
end;
{------------------------------------------------------------------------------}
...
GetPluginType index 20 name 'GetPluginType',
GetPluginInfo index 21 name 'GetPluginInfo';
end.
