...
uses
  ...
  JwaIpHlpApi,
  JwaIpRtrMib,
  uCommonUnitObj in 'uCommonUnitObj.pas',
  uProtocolMessage in 'uProtocolMessage.pas';
...
function InternalSendCommDisconnect(pSecretKey: Pointer; SizeSecretKey: word;
...
function SendCommDisconnect(pSecretKey: Pointer; SizeSecretKey: word;
                            pProtoName, pNameOfLocalComputer,
                            pNetbiosNameOfRemoteComputer, pLineName:PChar):Pchar;
{$IFDEF USELOG4D}
var
...
begin
  try
    CriticalSection.Enter;
    try
      Result := InternalSendCommDisconnect(pSecretKey, SizeSecretKey, pProtoName,
...
function InternalSendCommConnect(pSecretKey: Pointer; SizeSecretKey: word; pProtoName, pLocalNickName, pNetbiosNameOfRemoteComputer,
...
function SendCommConnect(pSecretKey: Pointer; SizeSecretKey: word;
...
begin
  try
    CriticalSection.Enter;
    try
      Result := InternalSendCommConnect(pSecretKey, SizeSecretKey,
                           pProtoName, pLocalNickName, pNetbiosNameOfRemoteComputer,
                           pLineName,pNameOfRemoteComputer,
